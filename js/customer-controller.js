...
function editCustomer(id) {
    ...
    $.ajax({
        method: 'GET',
        url : '../myphpPOS/phpController/customer-controller.php?search='+id,
        aysnc: true
    }).done(function(response){
        ...
        $('#customerAddress').val(customer[2]);
        $('#contactNo').val(customer[3]);
...
$('#btnDeleteCustomer').click(function () {
    ...
    $.ajax({
        method: 'GET',
        url : '../myphpPOS/phpController/customer-controller.php?deleteCustomer='+$('#customerId').val(),
        aysnc: true
    }).done(function(response){
